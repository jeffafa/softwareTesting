...
--Exercise 4 (Mark kan je hier nog even naar kijken? ik kon geen andere manier verzinnen dan dit)
...
--Exercise 5 (Mark kan je hier nog even naar kijken? Door 1 keer de io weg te halen heb ik er verder geen last van)  
  carmichael :: [Integer]
  ...
  --Exercise 6 (Mark kan je hier nog even GOED naar kijken?)
